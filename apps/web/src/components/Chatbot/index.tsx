      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
              ...
              {messages.map((m, i) => (
                <div 
                  ...
                  className={clsx(
                    ...
                    m.role === 'user' ? styles['chatbot__message-wrapper--user'] : styles['chatbot__message-wrapper--assistant']
                  )}
                >
                  <div className={clsx(
            ...
            {/* Input Area */}
            <form onSubmit={handleSubmit} className={styles['chatbot__input-area']} aria-label="Chat input">
