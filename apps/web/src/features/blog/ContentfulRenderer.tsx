  ...
  const options: Options = {
    ...
    renderNode: {
      [BLOCKS.PARAGRAPH]: (node: Block | Inline, children: ReactNode) => {
        ...
        const hasCodeBlock = node.content.some((c) =>
          c.nodeType === 'text' &&
      ...
      [BLOCKS.HEADING_1]: (_node: Block | Inline, children: ReactNode) => <h1>{children}</h1>,
      [BLOCKS.HEADING_2]: (_node: Block | Inline, children: ReactNode) => <h2>{children}</h2>,
      [BLOCKS.HEADING_3]: (_node: Block | Inline, children: ReactNode) => <h3>{children}</h3>,
      [BLOCKS.UL_LIST]: (_node: Block | Inline, children: ReactNode) => <ul>{children}</ul>,
      [BLOCKS.OL_LIST]: (_node: Block | Inline, children: ReactNode) => <ol>{children}</ol>,
      [BLOCKS.LIST_ITEM]: (_node: Block | Inline, children: ReactNode) => <li>{children}</li>,
      ...
      [BLOCKS.TABLE_ROW]: (_node: Block | Inline, children: ReactNode) => <tr>{children}</tr>,
